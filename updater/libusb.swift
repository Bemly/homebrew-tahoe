// updater/libusb.swift —— 与 Formula/libusb.rb 一一同名的检查器入口
//
// 运行：swiftc updater/UpdaterCore.swift updater/libusb.swift -o /tmp/check-libusb && /tmp/check-libusb
...
struct LibusbCheck {
    static func main() {
        runCheck(CheckConfig(formula: "libusb", brewName: "libusb"))
    }
}
