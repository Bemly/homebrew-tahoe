// updater/dtc.swift —— 与 Formula/dtc.rb 一一同名的检查器入口
//
// 运行：swiftc updater/UpdaterCore.swift updater/dtc.swift -o /tmp/check-dtc && /tmp/check-dtc
...
struct DtcCheck {
    static func main() {
        runCheck(CheckConfig(formula: "dtc", brewName: "dtc"))
    }
}
