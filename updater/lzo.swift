// updater/lzo.swift —— 与 Formula/lzo.rb 一一同名的检查器入口
//
// 运行：swiftc updater/UpdaterCore.swift updater/lzo.swift -o /tmp/check-lzo && /tmp/check-lzo
...
struct LzoCheck {
    static func main() {
        runCheck(CheckConfig(formula: "lzo", brewName: "lzo"))
    }
}
