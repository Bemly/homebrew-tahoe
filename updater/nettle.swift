// updater/nettle.swift —— 与 Formula/nettle.rb 一一同名的检查器入口
//
// 运行：swiftc updater/UpdaterCore.swift updater/nettle.swift -o /tmp/check-nettle && /tmp/check-nettle
...
struct NettleCheck {
    static func main() {
        runCheck(CheckConfig(formula: "nettle", brewName: "nettle"))
    }
}
