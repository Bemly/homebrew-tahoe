// updater/glib.swift —— 与 Formula/glib.rb 一一同名的检查器入口
//
// 运行：swiftc updater/UpdaterCore.swift updater/glib.swift -o /tmp/check-glib && /tmp/check-glib
...
struct GlibCheck {
    static func main() {
        runCheck(CheckConfig(formula: "glib", brewName: "glib"))
    }
}
