// updater/pixman.swift —— 与 Formula/pixman.rb 一一同名的检查器入口
//
// 运行：swiftc updater/UpdaterCore.swift updater/pixman.swift -o /tmp/check-pixman && /tmp/check-pixman
...
struct PixmanCheck {
    static func main() {
        runCheck(CheckConfig(formula: "pixman", brewName: "pixman"))
    }
}
