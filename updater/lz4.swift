// updater/lz4.swift —— 与 Formula/lz4.rb 一一同名的检查器入口
//
// 运行：swiftc updater/UpdaterCore.swift updater/lz4.swift -o /tmp/check-lz4 && /tmp/check-lz4
...
struct Lz4Check {
    static func main() {
        runCheck(CheckConfig(formula: "lz4", brewName: "lz4"))
    }
}
