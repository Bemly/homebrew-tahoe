// updater/json-c.swift —— 与 Formula/json-c.rb 一一同名的检查器入口
//
// 运行：swiftc updater/UpdaterCore.swift updater/json-c.swift -o /tmp/check-json-c && /tmp/check-json-c
...
struct JsonCCheck {
    static func main() {
        runCheck(CheckConfig(formula: "json-c", brewName: "json-c"))
    }
}
