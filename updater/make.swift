// updater/make.swift —— 与 Formula/make.rb 一一同名的检查器入口
//
// 运行：swiftc updater/UpdaterCore.swift updater/make.swift -o /tmp/check-make && /tmp/check-make
...
struct MakeCheck {
    static func main() {
        runCheck(CheckConfig(formula: "make", brewName: "make"))
    }
}
