// updater/xz.swift —— 与 Formula/xz.rb 一一同名的检查器入口
//
// 运行：swiftc updater/UpdaterCore.swift updater/xz.swift -o /tmp/check-xz && /tmp/check-xz
...
struct XzCheck {
    static func main() {
        runCheck(CheckConfig(formula: "xz", brewName: "xz"))
    }
}
