// updater/vde.swift —— 与 Formula/vde.rb 一一同名的检查器入口
//
// 运行：swiftc updater/UpdaterCore.swift updater/vde.swift -o /tmp/check-vde && /tmp/check-vde
...
struct VdeCheck {
    static func main() {
        runCheck(CheckConfig(formula: "vde", brewName: "vde"))
    }
}
