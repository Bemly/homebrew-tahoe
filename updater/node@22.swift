// updater/node@22.swift —— 与 Formula/node@22.rb 一一同名的检查器入口
//
// 运行：swiftc updater/UpdaterCore.swift "updater/node@22.swift" -o /tmp/check-node@22 && /tmp/check-node@22
// （须在仓库根目录执行；node@22 在 homebrew/core，走 brew 流，见 AGENTS.md 9.3）
//
