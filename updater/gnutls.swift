// updater/gnutls.swift —— 与 Formula/gnutls.rb 一一同名的检查器入口
//
// 运行：swiftc updater/UpdaterCore.swift updater/gnutls.swift -o /tmp/check-gnutls && /tmp/check-gnutls
...
struct GnutlsCheck {
    static func main() {
        runCheck(CheckConfig(formula: "gnutls", brewName: "gnutls"))
    }
}
