// updater/gmp.swift —— 与 Formula/gmp.rb 一一同名的检查器入口
//
// 运行：swiftc updater/UpdaterCore.swift updater/gmp.swift -o /tmp/check-gmp && /tmp/check-gmp
...
struct GmpCheck {
    static func main() {
        runCheck(CheckConfig(formula: "gmp", brewName: "gmp"))
    }
}
