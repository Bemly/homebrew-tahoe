// updater/qemu.swift —— 与 Formula/qemu.rb 一一同名的检查器入口
//
// 运行：swiftc updater/UpdaterCore.swift updater/qemu.swift -o /tmp/check-qemu && /tmp/check-qemu
...
struct QemuCheck {
    static func main() {
        runCheck(CheckConfig(formula: "qemu", brewName: "qemu"))
    }
}
