// updater/snappy.swift —— 与 Formula/snappy.rb 一一同名的检查器入口
//
// 运行：swiftc updater/UpdaterCore.swift updater/snappy.swift -o /tmp/check-snappy && /tmp/check-snappy
...
struct SnappyCheck {
    static func main() {
        runCheck(CheckConfig(formula: "snappy", brewName: "snappy"))
    }
}
