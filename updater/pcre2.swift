// updater/pcre2.swift —— 与 Formula/pcre2.rb 一一同名的检查器入口
//
// 运行：swiftc updater/UpdaterCore.swift updater/pcre2.swift -o /tmp/check-pcre2 && /tmp/check-pcre2
...
struct Pcre2Check {
    static func main() {
        runCheck(CheckConfig(formula: "pcre2", brewName: "pcre2"))
    }
}
