class NodeAT24 < Formula
  ...
  bottle do
    ...
    sha256 cellar: :any_skip_relocation, tahoe: "666d37e8d7cfb84b5106aa171b31897977b259f00ddcb52a78741c37dcd2fb2a"
  end
  ...
  def caveats
    <<~EOS
      ...
      切换来源必须先卸载再装另一个：
        用本 tap：brew uninstall node@24 && brew install bemly/tahoe/node@24
        用 core ：brew uninstall bemly/tahoe/node@24 && brew install node@24
