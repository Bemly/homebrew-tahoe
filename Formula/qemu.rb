class Qemu < Formula
  ...
  depends_on "bemly/tahoe-intel/gnutls"
  depends_on "bemly/tahoe-intel/jpeg-turbo"
  depends_on "bemly/tahoe-intel/libpng"
  depends_on "bemly/tahoe-intel/libslirp"
  depends_on "bemly/tahoe-intel/libssh"
  depends_on "bemly/tahoe-intel/libusb"
  depends_on "bemly/tahoe-intel/lzo"
  depends_on "bemly/tahoe-intel/ncurses"
  depends_on "bemly/tahoe-intel/pixman"
  depends_on "bemly/tahoe-intel/snappy"
  depends_on "bemly/tahoe-intel/vde"
  depends_on "bemly/tahoe-intel/zstd"
